...
---
데이터사이언스학부 데이터사이언스전공 2023062760 정병윤 burnix159@hanyang.ac.kr    
데이터사이언스학부 심리뇌과학전공     2023066735 전용현 jyh010328@hanyang.ac.kr
...
* **목적**: 물류창고 2D 그리드 환경에서 강화학습(DQN) 방법을 통해 ‘픽업' 작업을 최단 이동 스텝으로 수행하고, 장애물 회피를 학습한 정책(policy) 학습
* **핵심 기여**:

  * 에피소드 평균 성공률 ≥ 70% 달성 목표
...
현대 물류창고에서는 로봇이 상품을 픽업하고 목표지점으로 상품을 배송합니다.
...
1. **학습 성능 개선**
   ...
   * 에피소드 평균 성공률 ≥ 70% (장애물 비율 0.2 환경 기준)
   * 
2. **학습 효율성**
...
* **전용현**
  ...
  * DQN 에이전트 학습 및 보상 , 시연 영상 제작, 코드 제작, 블로그 편집
* **정병윤**

  * 블로그 작성 및 보고서 편집, 충돌/성공률 평가, 코드 제작

**Video**  
    https://youtu.be/2nkG6AbM_Tc
